...
const urlReport = {
  ...
  http: {
    ...
    response_headers: {
      ...
      "Content-Security-Policy":
        "default-src 'none'; connect-src 'self' https://*.gouv.fr; font-src 'self'; img-src 'self'; prefetch-src 'self' https://*.gouv.fr; script-src 'self' https://*.gouv.fr; frame-src 'self' https://*.gouv.fr; style-src 'self' 'unsafe-inline'",
    ...
    details: {
      "content-security-policy": {
        ...
        output: {
          data: {
            "connect-src": ["https://*.gouv.fr", "'self'"],
            "default-src": ["'none'"],
            "font-src": ["'self'"],
            "frame-src": ["https://*.gouv.fr", "'self'"],
            "img-src": ["'self'"],
            "prefetch-src": ["https://*.gouv.fr", "'self'"],
            "script-src": ["https://*.gouv.fr", "'self'"],
      ...
      contribute: {
        ...
        score_description:
          "Contribute.json isn't required on websites that don't belong to Mozilla",
        score_modifier: 0,
      },
      cookies: {
  ...
  updownio: {
    ...
    enabled: true,
    published: true,
    disabled_locations: ["lan", "mia", "bhs", "sin", "tok", "syd"],
    last_check_at: "2021-09-03T23:56:41Z",
    next_check_at: "2021-09-03T23:57:40Z",
    mute_until: null,
    favicon_url:
      "https://www.fabrique.social.gouv.fr/images/favicons/favicon-16x16.png",
    custom_headers: {},
    http_verb: "GET/HEAD",
    http_body: "",
    ssl: {
  ...
  testssl: [
    ...
    },
    {
      ...
      severity: "INFO",
      finding:
        "'renegotiation info/#65281' 'server name/#0' 'EC point formats/#11' 'session ticket/#35' 'next protocol/#13172' 'max fragment length/#1' 'application layer protocol negotiation/#16' 'extended master secret/#23'",
    },
    {
    ...
    },
    {
      ...
      severity: "INFO",
      finding:
        "F882D3AFD97B9346B3C17D8B8A0A5FF6D49A198B92C15FFFA4E094072641C570",
    },
    {
      id: "cert",
      ip: "www.fabrique.social.gouv.fr/20.74.14.77",
    ...
    },
    {
      ...
      cwe: "CWE-310",
      finding:
        "Make sure you don't use this certificate elsewhere with SSLv2 enabled services, see https://censys.io/ipv4?q=F882D3AFD97B9346B3C17D8B8A0A5FF6D49A198B92C15FFFA4E094072641C570",
    },
    {
      id: "LOGJAM",
      ip: "www.fabrique.social.gouv.fr/20.74.14.77",
  ...
  nuclei: [
    {
      ...
      extracted_results: ["nginx/1.17.8"],
      ip: "20.74.14.77",
  ...
  lhr: [{
    ...
    categories: {
      ...
      pwa: {
        ...
        manualDescription:
          "These checks are required by the baseline [PWA Checklist](https://developers.google.com/web/progressive-web-apps/checklist) but are not automatically checked by Lighthouse. They do not affect your score but it's important that you verify them manually.",
        id: "pwa",
        score: 0.42,
      },
    },
